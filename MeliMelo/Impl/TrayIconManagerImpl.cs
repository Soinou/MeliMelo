...
namespace MeliMelo.Impl
{
    ...
    /// </summary>
    internal sealed class TrayIconManagerImpl : ITrayIconManager, IDisposable
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public TrayIconManagerImpl(string text, Icon icon)
        {
        ...
        {
            icon_.ShowBalloonTip(100, title, message, ToolTipIcon.Info);
        }
