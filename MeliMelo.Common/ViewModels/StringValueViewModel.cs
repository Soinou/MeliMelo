...
{
    public interface IStringValueViewModelFactory
    {
        StringValueViewModel Create();

        void Release(StringValueViewModel view_model);
    }

    public class StringValueViewModel : PropertyChangedBase
    {
